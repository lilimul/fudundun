...
export const Canvas = props => {
  ...
  return <canvas width={canvas_state.size.width} height={canvas_state.size.height} onMouseUp={handleMouseUp} onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} ref={reff} {...props} />;
}
